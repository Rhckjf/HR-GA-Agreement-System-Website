      ...
      >
        ...
        <div className="relative z-10 flex flex-col justify-center items-start p-16 text-white">
          ...
          <p className="text-xl leading-relaxed max-w-md opacity-90">
            PT Diamond Electric Indonesia's HR & GA agreement management website with centralized tracking, vendor management, and automatic expiration alerts.
          </p>
        </div>
      </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-stone-200 p-8">
            ...
            {isLogin && (
              <div className="mt-6 p-4 bg-stone-50 rounded-md border border-stone-200">
                <p className="text-xs text-stone-500 mb-2 font-medium">Default Admin Credentials:</p>
                <p className="text-xs font-mono text-stone-600">Email: admin@company.com</p>
                <p className="text-xs font-mono text-stone-600">Password: Admin123!</p>
              </div>
            )}
          </div>
        </div>
